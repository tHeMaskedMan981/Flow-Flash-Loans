...
pub contract BasicToken2: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @BasicToken2.Vault
        ...
        destroy() {
            BasicToken2.totalSupply = BasicToken2.totalSupply - self.balance
            if (self.balance > 0.0) {
    ...
    init() {
        ...
        self.TokenStoragePath = /storage/BasicToken2Vault
        self.TokenPublicReceiverPath = /public/BasicToken2Receiver
        self.TokenPublicBalancePath = /public/BasicToken2Balance
        ...
        self.account.link<&BasicToken2.Vault{FungibleToken.Receiver}>(
        ...
        self.account.link<&BasicToken2.Vault{FungibleToken.Balance}>(
