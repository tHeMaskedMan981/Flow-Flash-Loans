...
pub contract BasicToken1: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @BasicToken1.Vault
        ...
        destroy() {
            BasicToken1.totalSupply = BasicToken1.totalSupply - self.balance
            if (self.balance > 0.0) {
    ...
    init() {
        ...
        self.TokenStoragePath = /storage/BasicToken1Vault
        self.TokenPublicReceiverPath = /public/BasicToken1Receiver
        self.TokenPublicBalancePath = /public/BasicToken1Balance
        ...
        self.account.link<&BasicToken1.Vault{FungibleToken.Receiver}>(
        ...
        self.account.link<&BasicToken1.Vault{FungibleToken.Balance}>(
